...
export const experience: Experience[] = [
  {
    ...
    company: "CreativeOnix",
    period: "Mar 2026 — Present",
    description:
      "Leading full-stack development across web platforms, AI integrations, and scalable backend systems. Driving architecture decisions, code quality, and end-to-end product delivery.",
  },
  {
    ...
    description:
      "Led Supportiyo's technology and product engineering across AI voice systems, backend infrastructure, and platform development. Responsible for system architecture, scalability, security, and production readiness.",
  },
  {
